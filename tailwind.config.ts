  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        royal: "hsl(var(--royal))",
        src: {
          class: "hsl(var(--src-class))",
          species: "hsl(var(--src-species))",
          feat: "hsl(var(--src-feat))",
          item: "hsl(var(--src-item))",
          custom: "hsl(var(--src-custom))",
        },
        sidebar: {
      ...
      boxShadow: {
        ...
        'parchment-card': 'var(--shadow-card)',
        'parchment-inset': 'var(--shadow-inset)',
      },
      keyframes: {
